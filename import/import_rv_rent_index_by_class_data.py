...
def getClassRentIndexAllTerritories(fileLoc, tableName):
    ...
    print("Rent indices imported to database")

#Import data from housing price by class sheet
fileName = "../raw_data/rv_data/rent_indices_annual_from-80.csv"

tableName = "rv_rent_index_by_class_data"

#Import bulk data into database
 
getClassRentIndexAllTerritories(fileName, tableName)
